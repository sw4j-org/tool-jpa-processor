 ...
 * @author Uwe Plonus
 */
public class EmptyTableEntityIT extends ITSuperclass {

    @Test
    public void testChangeSetElement() throws XPathExpressionException {
        Node changeSet = getNode("/databaseChangeLog" +
                "/changeSet[starts-with(@id, 'createTable_EmptyTableEntity')]");
        ...
        Assert.assertTrue(getAttribute("id", changeSet).getNodeValue()
                .startsWith("createTable_EmptyTableEntity"),
                "Expected the id attribute to start with \"createTable_EmptyTableEntity\"");
    ...
    public void testCreateTableElement() throws XPathExpressionException {
        Node createTable = getNode("/databaseChangeLog" +
                "/changeSet[starts-with(@id, 'createTable_EmptyTableEntity')]" +
                "/createTable[@tableName='EmptyTableEntity']");
        ...
        Assert.assertEquals(getAttribute("tableName", createTable).getNodeValue(), "EmptyTableEntity",
                "Expected the tableName attribute to be \"EmptyTableEntity\"");
    }
