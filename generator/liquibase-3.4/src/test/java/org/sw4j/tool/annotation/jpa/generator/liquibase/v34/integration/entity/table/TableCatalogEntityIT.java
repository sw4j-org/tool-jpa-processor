 ...
 * @author Uwe Plonus
 */
public class TableCatalogEntityIT extends ITSuperclass {

    @Test
    public void testChangeSetElement() throws XPathExpressionException {
        Node changeSet = getNode("/databaseChangeLog" +
                "/changeSet[starts-with(@id, 'createTable_TableCatalogEntity')]");
        ...
        Assert.assertTrue(getAttribute("id", changeSet).getNodeValue()
                .startsWith("createTable_TableCatalogEntity"),
                "Expected the id attribute to start with \"createTable_TableCatalogEntity\"");
    ...
    public void testCreateTableElement() throws XPathExpressionException {
        Node createTable = getNode("/databaseChangeLog" +
                "/changeSet[starts-with(@id, 'createTable_TableCatalogEntity')]" +
                "/createTable[@tableName='TableCatalogEntity']");
        ...
        Assert.assertEquals(getAttribute("tableName", createTable).getNodeValue(), "TableCatalogEntity",
                "Expected the tableName attribute to be \"TableCatalogEntity\"");
    }
    ...
    public void testTableCatalogElement() throws XPathExpressionException {
        ...
        Assert.assertNotNull(createTable, "Expected a createTable to be created.");
        Assert.assertNotNull(getAttribute("catalogName", createTable),
                "Expected the createTable to have a catalogName attribute.");
        Assert.assertEquals(getAttribute("catalogName", createTable).getNodeValue(), "CATALOG",
                "Expected the catalogName attribute to be \"CATALOG\"");
    }
