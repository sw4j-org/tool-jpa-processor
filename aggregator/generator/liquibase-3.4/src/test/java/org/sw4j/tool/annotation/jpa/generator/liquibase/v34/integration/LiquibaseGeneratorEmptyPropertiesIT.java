 ...
 * @author Uwe Plonus
 */
public class LiquibaseGeneratorEmptyPropertiesIT {
    ...
    private static final String TEST_PROPERTIES = "src/test/resources/empty.properties";
    ...
    /** Default constructor. */
    public LiquibaseGeneratorEmptyPropertiesIT() {
    }
