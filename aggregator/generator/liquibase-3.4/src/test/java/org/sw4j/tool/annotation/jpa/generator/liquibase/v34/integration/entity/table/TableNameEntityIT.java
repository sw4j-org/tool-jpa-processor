...
public class TableNameEntityIT extends ITSuperclass {
    ...
    public void testChangeSetElement() throws XPathExpressionException {
        ...
        Assert.assertTrue(getAttribute("id", changeSet).getNodeValue()
                .startsWith("createTable_TableNameEntity"),
                "Expected the id attribute to start with \"createTable_TableNameEntity\"");
    ...
    public void testCreateTableElement() throws XPathExpressionException {
        Node createTable = getNode("/databaseChangeLog" +
                "/changeSet[starts-with(@id, 'createTable_TableNameEntity')]" +
                "/createTable[@tableName='TAB_NAME']");
        ...
        Assert.assertEquals(getAttribute("tableName", createTable).getNodeValue(), "TAB_NAME",
                "Expected the tableName attribute to be \"TAB_NAME\"");
    }
